...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const now = new Date();
  const staticPaths = [
    "", "/mental-health","/general-health","/prevention","/relationships","/family-parenting","/workplace","/environment","/social","/training","/campaigns","/about","/help","/contact","/search","/authors","/reviewers","/privacy","/terms","/disclaimer","/editorial-policy","/medical-review","/newsletter",
  ];
