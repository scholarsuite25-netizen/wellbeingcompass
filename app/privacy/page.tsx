...
export default function Page(){
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 prose-wellmind text-sm">
      ...
      <p>We collect only what we need to operate WellMind Health. We minimize personal data, do not sell reader data, and avoid tracking sensitive health searches.</p>
